export const DEFAULT_CATEGORIES = [
  ...
  { id: 'c12', name: 'Capital Loss',   icon: '📉', color: '#ef4444', type: 'expense' },
  ...
  { id: 'i6',  name: 'Capital Gain — STCG', icon: '📈', color: '#10b981', type: 'income'  },
  { id: 'i7',  name: 'Capital Gain — LTCG', icon: '📊', color: '#059669', type: 'income'  },
  // Investments
